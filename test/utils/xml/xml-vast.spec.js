...
describe('VAST XML', () => {
  const sampleVastXmlStr = '<?xml version="1.0" encoding="UTF-8"?>' +
  ...
  it('must contain an Ad with id = 107195552', () => {
      ...
      describe('creatives', () => {
        ...
        describe('creative', () => {
          ...
          describe('linear', () => {
            ...
            it('must contain the duration', () => {
              assert.equal(linear.duration.keyValue, '00:00:20');
            });

            it('must contain tracking events', () => {
            ...
            describe('trackingEvents', () => {
              it('must contain start event', () => {
                const trackingEvents = linear.trackingEvents.tracking;
