...
describe('TrackingEvent', () => {
  ...
  describe('offset', () => {
    it('must not be added if the event is not progress', () => {
    ...
    it('must be added if the event progress and the attr is present and the duration is passed to the constructor', () => {
